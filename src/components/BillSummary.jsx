...
//     if (orgId) {
//       // Fetch categories
//       fetch('https://production-db-993e8-default-rtdb.firebaseio.com/categories.json')
//         .then((res) => res.json())
//         .then((data) => {
//           if (data) {
...
//       // Fetch subcategories
//       fetch('https://production-db-993e8-default-rtdb.firebaseio.com/subcategories.json')
//         .then((res) => res.json())
//         .then((data) => {
//           if (data) {
