...
//     if (orgId) {
//       // Fetch categories
//       fetch('https://smart-server-stage-database-default-rtdb.firebaseio.com/categories.json')
//         .then((res) => res.json())
//         .then((data) => {
//           if (data) {
...
//       // Fetch subcategories
//       fetch('https://smart-server-stage-database-default-rtdb.firebaseio.com/subcategories.json')
//         .then((res) => res.json())
//         .then((data) => {
//           if (data) {
...
//       // Fetch menu items
//       fetch('https://smart-server-stage-database-default-rtdb.firebaseio.com/menu_items.json')
//         .then((res) => res.json())
//         .then((data) => {
//           if (data) {
