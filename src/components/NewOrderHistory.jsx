...
import { List, Card, Button, Popconfirm, Tag, Empty, Badge, Input, Row, Col, message, Rate, Pagination } from 'antd';
import { 
  DeleteOutlined, 
  ClockCircleOutlined, 
  TableOutlined, 
...
function NewOrderHistory() {
  ...
  const [ordersPerPage, setOrdersPerPage] = useState(20); // Limit number of orders shown at once
