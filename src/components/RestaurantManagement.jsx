...
const RestaurantManagement = () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const [id, restaurantData] =
          restaurantsArray.find(([_, r]) => r.orgId === orgId) || [];
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://smart-server-stage-database-default-rtdb.firebaseio.com/restaurants/${id}.json`,
        {
          method: "PATCH",
          headers: {
      ...
      case "privacy":
        return (
          <div style={sectionStyle}>
            <h2 style={{ color: "#FF0000", marginBottom: "1.5rem" }}>
              Privacy Policy
            </h2>
            <div style={{ color: "#333", lineHeight: "1.6" }}>
              <p style={{ marginBottom: "1.5rem" }}>
                At Smart Server, we take your privacy seriously. This policy
              ...
              <ul style={{ marginBottom: "1.5rem", paddingLeft: "1.5rem" }}>
                <li style={{ marginBottom: "0.5rem" }}>
                  Basic contact information (name, email, phone number and
                  location)
                </li>
                <li style={{ marginBottom: "0.5rem" }}>
                  Restaurant details and preferences
                </li>
                <li style={{ marginBottom: "0.5rem" }}>
              ...
              <ul style={{ marginBottom: "1.5rem", paddingLeft: "1.5rem" }}>
                ...
                <li style={{ marginBottom: "0.5rem" }}>
                  Enhance platform security and prevent fraud
                </li>
              </ul>
              ...
              <p style={{ marginBottom: "1.5rem" }}>
                <strong>Phone:</strong> +91 955 331 3334
              </p>
      ...
      case "refund":
        return (
          <div style={sectionStyle}>
            ...
            <div style={{ color: "#333", lineHeight: "1.6" }}>
              <p style={{ marginBottom: "1.5rem" }}>
                Smart Server is committed to ensuring customer satisfaction.
                This policy outlines our refund procedures for our services.
              </p>
              ...
              <p style={{ marginBottom: "1.5rem" }}>
                We offer a 7-day money-back guarantee on new subscriptions.
                Refund requests must be submitted within 7 days of the initial
                purchase.
              </p>
              ...
              <ol style={{ marginBottom: "1.5rem", paddingLeft: "1.5rem" }}>
                <li style={{ marginBottom: "0.5rem" }}>
                  Submit a refund request via email
                </li>
                <li style={{ marginBottom: "0.5rem" }}>
                  Include order details and reason for refund
                </li>
                <li style={{ marginBottom: "0.5rem" }}>
      ...
      case "terms":
        return (
          <div style={sectionStyle}>
            ...
            <div style={{ color: "#333", lineHeight: "1.6" }}>
              <p style={{ marginBottom: "1.5rem" }}>
                By using Smart Server's platform and services, you agree to
              ...
              <ul style={{ marginBottom: "1.5rem", paddingLeft: "1.5rem" }}>
                ...
                <li style={{ marginBottom: "0.5rem" }}>
                  Platform must be used in compliance with local laws
                </li>
              </ul>
              ...
              <p style={{ marginBottom: "1.5rem" }}>
                All content, features, and functionality are owned by Smart
                Server and protected by international copyright laws.
              </p>
              ...
              <p style={{ marginBottom: "1.5rem" }}>
                Smart Server shall not be liable for any indirect, incidental,
      ...
      case "about":
        return (
          <div style={sectionStyle}>
            ...
            <div style={{ color: "#333", lineHeight: "1.6" }}>
              <p style={{ marginBottom: "1.5rem" }}>
                Smart Server is a cutting-edge digital restaurant management
                platform that transforms traditional dining experiences through
                innovative technology solutions. As industry leaders in
                restaurant digitization, we specialize in providing seamless
                QR-based ordering systems that enhance both customer
              ...
              <p style={{ marginBottom: "1.5rem" }}>
                We are dedicated to revolutionizing the restaurant industry by
                providing state-of-the-art digital solutions that streamline
                operations, reduce wait times, and create exceptional dining
                experiences. Our platform empowers restaurants to embrace
                digital transformation while maintaining their unique identity
                and service quality.
              </p>
              ...
              <ul style={{ marginBottom: "1.5rem", paddingLeft: "1.5rem" }}>
                <li style={{ marginBottom: "0.5rem" }}>
                  Dynamic QR-based digital menu system
                </li>
                <li style={{ marginBottom: "0.5rem" }}>
              ...
              >
                <p>
                  © {new Date().getFullYear()} Smart Server. All rights
                  reserved.
                </p>
              </div>
            </div>
        ...
        <>
          ...
          {activeSection ? (
            <div>
              ...
              <div style={{ padding: "0rem" }}>{renderSection()}</div>
            </div>
          ) : (
            /* Profile menu cards */
            <div>
              ...
              >
                <div
                  style={{
                    ...
                    bottom: 0,
                    background:
                      "linear-gradient(45deg, #FF0000 0%, #FF6B6B 100%)",
                    borderRadius: "1rem",
