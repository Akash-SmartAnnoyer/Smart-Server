...
const ChargesManagement = () => {
  ...
  const onFinish = async (values) => {
    try {
      ...
      if (editingId) {
        ...
        await fetch(`https://smartdb-175f4-default-rtdb.firebaseio.com/restaurants/${orgId}/charges/${editingId}.json`, {
          method: 'PUT',
        ...
        // Add new charge
        await fetch(`https://smartdb-175f4-default-rtdb.firebaseio.com/restaurants/${orgId}/charges.json`, {
          method: 'POST',
          body: JSON.stringify(chargeData)
        });
  ...
  const handleDelete = async (id) => {
    try {
      await fetch(`https://smartdb-175f4-default-rtdb.firebaseio.com/restaurants/${orgId}/charges/${id}.json`, {
        method: 'DELETE'
      });
  ...
  const handleToggleCharge = async (record, enabled) => {
    try {
      await fetch(`https://smartdb-175f4-default-rtdb.firebaseio.com/restaurants/${orgId}/charges/${record.id}.json`, {
        method: 'PATCH',
