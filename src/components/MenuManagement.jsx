...
const API_URL =
  "https://smart-server-stage-database-default-rtdb.firebaseio.com";
...
const ModernMenuManagement = () => {
      ...
      <AnimatePresence>
        ...
        >
          ...
          >
            <Input
              prefix={
                <IoSearch style={{ fontSize: "20px", color: theme.primary }} />
              }
              suffix={
                <Badge
                  count={
      ...
      <>
        ...
        {imageInputType === "url" ? (
          ...
          <Form.Item
            ...
            rules={[
              { required: !editingItem, message: "Please upload the image!" },
            ]}
          >
  ...
  const ModernCategoryCard = ({ item, type }) => (
    <Card
      ...
      style={{
        ...
        borderRadius: "16px",
        backgroundColor:
          type === "category" ? theme.secondary : theme.background,
            ...
            <Space>
              <div>
                ...
                {type === "subcategory" && (
                  ...
                  >
                    {
                      categories.find((c) => c.firebaseId === item.categoryId)
                        ?.name
                    }
                  </Text>
                )}
        ...
        >
          ...
          >
            <Switch
              ...
              size="small"
              style={{
                backgroundColor: item.isAvailable ? theme.primary : undefined,
              }}
            />
            <Space size="small">
              <Button
  ...
  document.head.insertAdjacentHTML(
    "beforeend",
    `<style>${modernDrawerStyles}</style>`
  );
  ...
  document.head.insertAdjacentHTML(
    "beforeend",
    `<style>${updatedScrollStyles}</style>`
  );
